    ...
    <tbody>
        ...
        <?php while($contact2 = $afficheContact->fetch(PDO::FETCH_ASSOC)):?>
            <tr>
                ...
                <td>
                    <a href="exo3.php?click=1">autre info</a>
                    <?php
                        if (isset($_GET["click"])) {
                            $contact2['annee_rencontre'] ;
                            $contact2['email'] ;
                            $contact2['type_contact'] ;
                            echo "<div id='number'>".$contact2['annee_rencontre']."</div>";
                            echo "<div id='number'>".$contact2['email']."</div>";
                            echo "<div id='number'>".$contact2['type_contact']."</div>";
                        }
                    ?>
                </td>
                ...
                <td>
                    <button>
                        <select name="#" id="#">
                            <option value=""> <?=$contact2['annee_rencontre'] ?></option>
                            <option value=""> <?=$contact2['email'] ?></option>
                            <option value="">  <?=$contact2['type_contact'] ?></option>
                        </select>
                    </button>
                </td>
                <!-- <td>
